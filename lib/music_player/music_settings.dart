    ...
    return Scaffold(backgroundColor: Colors.black,
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ElevatedButton(onPressed: (){}, child: Text("Account",style: TextStyle(color: Colors.blueAccent),),),
            SizedBox(height: 8.0),

            ElevatedButton(onPressed: (){}, child: Text("Languages",style: TextStyle(color: Colors.blueAccent),)),
            SizedBox(height: 8.0),

            ElevatedButton(onPressed: (){}, child: Text("About",style: TextStyle(color: Colors.blueAccent),)),
            SizedBox(height: 8.0),
